...
/*   Updated: 2025/02/11 13:53:28 by rita             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "push_swap.h"

// Will update all the "id" or current_index & "is_above_median"(1/0) 
//		in given stack.
// "id" :: is the current position of the node in the stack
// "aprox_middle" :: we will calculate an ""average or aproximative middle"" 
//		value in the given stack. And then we compare every id to the
//		aprox_middle. If 'id' lower than 'aprox_middle' then
//		"is_above_median"=TRUE else "is_above_median"=FALSE
